...
const services = [
  ...
  },
  {
    ...
    title: 'AI Solutions',
    description: 'Scalable, secure, and innovative cloud integrations.',
  },
];
...
export function WhatWeDo() {
  ...
  {/* Minor image */}
  <Image
    src="/service-minor.png"
    alt="Our Services"
    width={800}
    height={400}
    className="absolute top-1/2 left-1/2 w-[60%] h-auto -translate-x-1/2 -translate-y-1/2 rounded-2xl shadow-2xl"
  />
</div>
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-3">
          {services.map((service, index) => (
            <div 
              key={service.title} 
              className={index === 0 ? 'bg-gray-100 rounded-xl p-8' : 'pt-8'}
            >
